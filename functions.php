<?php
	...
	function wpbeg_title($title){
		if(is_front_page()&&is_home()){ //トッページなら
	...
	function wpbeg_script(){
		wp_enqueue_style('mpluslp','//fonts.googleapis.com/earlyaccess/mplus1p.css',array());
		wp_enqueue_style('Sacramento','//fonts.googleapis.com/css?family=Sacramento&amp;amp;subset=latin-ext',array());
		wp_enqueue_style('font-awsome','//maxcdn.bootstrapcdn.com/font-awesome/4.7.0/css/font-awesome.min.css','4.7.0');
